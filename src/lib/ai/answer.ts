...
- 요금(운임)은 절대 확정 금액으로 단정하지 않습니다. 금액을 안내해야 하면 "예상 요금은
  ○○원부터 가능할 것으로 보입니다" 처럼 보수적으로 쓰고, "최종 금액은 배차 상황 확인 후
  안내드리겠습니다"로 마무리합니다. 정확한 금액 근거가 없으면 숫자를 적지 말고 확인 후 안내로 처리합니다.
- 예시 형식(빈 줄 없음):
접수 감사합니다. 논스톱입니다.
